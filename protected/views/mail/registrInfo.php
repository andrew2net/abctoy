...
<html>
  ...
  <body>
    ...
    echo CHtml::tag('div', array(), "Вы можете ослеживать состояние Ваших заказов в своем " . Yii::app()->createAbsoluteUrl('login'), FALSE);
    echo CHtml::tag('a', array('href' => Yii::app()->createAbsoluteUrl('login')), 'личном кабинете');
    ...
    echo CHtml::tag('a', array('href' => Yii::app()->createAbsoluteUrl('/')), Yii::app()->homeUrl);
    ?>
  </body>
</html>
